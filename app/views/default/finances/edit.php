            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" enctype="multipart/form-data" method="post">
                        ...
                        <input type="hidden" name="fid" value="<?php echo $finance->FinanceID; ?>" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select name="Type" class="form-control" required="">
                                    ...
                                    <option value="1" <?php echo ($finance->Type) == 1 ? "selected" : ''; ?>>Deposit</option>
                                    <option value="0" <?php echo ($finance->Type) == 0 ? "selected" : ''; ?>>Withdrawal</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-sm-10">
                                <a href="<?php echo view::url('finances'); ?>" class="btn btn-warning">Back</a>
                                <button id="send" type="submit" class="btn btn-success">Update Finance</button>
                            </div>
                        </div>
                    </form>
